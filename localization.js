  ...
  const bundles = {
    ru: {
      ...
      ui: {
        ...
        tutorialModeFull: "Глава 1: Полный путь",
        tutorialModeCells: "Глава 2: Клетки и действия",
        tutorialModeQuick: "Глава 3: Быстрый старт",
      ...
      tutorial: {
        ...
        shop: { title: "Лавка", body: "В лавке покупаются предметы за золото. Нажмите кнопку покупки у выбранного предмета: он сразу попадет в инвентарь активного игрока." },
        ...
        blackMarketUse: { title: "Покупка на Теневом торге", body: "На Теневом торге доступны редкие товары. Откройте меню и купите любой предмет из списка." },
        blackMarketUseAction: "Открыть товары",
        altarRoll: { title: "Клетка Алтаря", body: "Сделайте бросок и перейдите на клетку Алтаря." },
        altarUse: { title: "Ритуал Алтаря", body: "Алтарь активирует особый ритуал клетки: усиление, защиту или штраф в зависимости от исхода. Откройте меню и подтвердите действие кнопкой ритуала." },
        altarUseAction: "Открыть алтарь",
        fortuneRoll: { title: "Клетка Оракула", body: "Сделайте бросок и перейдите на клетку Оракула." },
        fortuneUse: { title: "Пророчество", body: "Оракул выдает задание или эффект для текущего игрока. После активации подсказка появится в логах и может задать цель на несколько ходов вперед." },
        ...
        effects: { title: "Эффекты", body: "Панель эффектов показывает временные состояния: бонусы к броску, защиту от ловушек и другие модификаторы хода." },
    ...
    en: {
      ...
      ui: {
        ...
        tutorialModeFull: "Chapter 1: Full Walkthrough",
        tutorialModeCells: "Chapter 2: Tiles and Actions",
        tutorialModeQuick: "Chapter 3: Quick Start",
        tutorialSkip: "Skip",
        tutorialNext: "Next",
      ...
      tutorial: {
        ...
        shop: { title: "The Shop", body: "The shop lets you buy items for gold. Press a purchase button on any item to add it directly to the active player's inventory." },
        ...
        blackMarketUse: { title: "Shadow Market Purchase", body: "The Shadow Market offers rare items. Open the panel and buy any item from its list." },
        blackMarketUseAction: "Open Goods",
        altarRoll: { title: "Altar Tile", body: "Roll and move onto an Altar tile." },
        altarUse: { title: "Altar Ritual", body: "The Altar triggers a special cell ritual: buffs, protection, or penalties depending on the result. Open the panel and confirm the ritual action." },
        altarUseAction: "Open Altar",
        fortuneRoll: { title: "Oracle Tile", body: "Roll and move onto an Oracle tile." },
        fortuneUse: { title: "Oracle Prophecy", body: "The Oracle grants a quest or effect for the current player. After activation, the hint appears in logs and can define goals for upcoming turns." },
        ...
        effects: { title: "Effects", body: "The effects panel displays temporary statuses: roll bonuses, trap protection, and other turn modifiers." },
    ...
    uk: {
      ...
      ui: {
        ...
        tutorialModeFull: "Розділ 1: Повний шлях",
        tutorialModeCells: "Розділ 2: Клітинки та дії",
        tutorialModeQuick: "Розділ 3: Швидкий старт",
      ...
      tutorial: {
        ...
        shop: { title: "Крамниця", body: "У крамниці купуються предмети за золото. Натисніть кнопку покупки біля предмета: він одразу потрапить в інвентар активного гравця." },
        ...
        blackMarketUse: { title: "Покупка на Тіньовому торзі", body: "На Тіньовому торзі доступні рідкісні товари. Відкрийте меню і купіть будь-який предмет зі списку." },
        blackMarketUseAction: "Відкрити товари",
        altarRoll: { title: "Клітинка Вівтаря", body: "Зробіть кидок і перейдіть на клітинку Вівтаря." },
        altarUse: { title: "Ритуал Вівтаря", body: "Вівтар запускає особливий ритуал клітинки: підсилення, захист або штраф залежно від результату. Відкрийте меню та підтвердьте ритуал кнопкою дії." },
        altarUseAction: "Відкрити вівтар",
        fortuneRoll: { title: "Клітинка Оракула", body: "Зробіть кидок і перейдіть на клітинку Оракула." },
        fortuneUse: { title: "Пророцтво", body: "Оракул видає завдання або ефект для поточного гравця. Після активації підказка з’явиться в логах і може задати ціль на кілька ходів." },
        ...
        effects: { title: "Ефекти", body: "Панель ефектів показує тимчасові стани: бонуси до кидка, захист від пасток та інші модифікатори ходу." },
