  ...
  const bundles = {
    ru: {
      ...
      context: {
        ...
        blackMarketSubtitle: "Выберите игрока на клетке Черного рынка и нажмите кнопку действия.",
        ...
        playerLabelBlackMarket: "Участник сделки",
      ...
      emptySelect: {
        ...
        blackMarket: "-- На Черном рынке нет игроков --",
      ...
      ui: {
        ...
        configBlackMarketProfitChance: "Прибыльный рынок",
    ...
    en: {
      ...
      context: {
        ...
        blackMarketSubtitle: "Choose a player on the Shadow market tile and press the action button.",
        ...
        playerLabelBlackMarket: "Deal participant",
      ...
      ui: {
        ...
        configBlackMarketProfitChance: "Profitable market",
    ...
    uk: {
      ...
      context: {
        ...
        blackMarketSubtitle: "Виберіть гравця на клітинці Тіньового торгу та натисніть кнопку дії.",
        ...
        playerLabelBlackMarket: "Учасник угоди",
      ...
      ui: {
        ...
        configBalanceTitle: "Баланс",
        configFortuneGoodChance: "Хороший знак",
        configBlackMarketProfitChance: "Прибутковий ринок",
